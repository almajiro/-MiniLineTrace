...
void main(void)
{
	...
	while(1){
		...
		switch(sensor){
			case 0x01: // ●●●○ 右1 (左へ) 0001
			case 0x03: // ●●○○ 右2 (左へ) 0011
			case 0x02: // ●●○● 右3 (左へ) 0010
				R_IN1 = 0;
				R_IN2 = 0;
				L_IN1 = 1;
				L_IN2 = 0;
			...
			case 0x08: // ○●●● 左1 (右へ) 1000
			case 0x0C: // ○○●● 左2 (右へ) 1100
			case 0x04: // ●○●● 左3 (右へ) 0100
				R_IN1 = 0;
				R_IN2 = 1;
				L_IN1 = 0;
				L_IN2 = 0;
			...
			case 0x06: // ●○○● 中心 (直進) 0110
			case 0xFF: // ○○○○ クロスライン(直進) 1111
				R_IN1 = 0;
				R_IN2 = 1;
				L_IN1 = 1;
				L_IN2 = 0;
